...
public class ComprasViewPdf extends AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
		...
		celdaHeader=new PdfPCell(new Phrase("Panaderia  Panecillos", fuenteHeader));
...
;
		...
		celdaHeader2=new PdfPCell(new Phrase("Direccion: Jr. Poseidón, Santiago de Surco 15054 "
...
;
		...
		*/
		...
		Font fuente=FontFactory.getFont("Helvetica", 10, Color.BLACK);
		
		Color color=new Color(255,200,1);
		...
		PdfPCell c3=null; 
		c3=new PdfPCell(new Phrase("Precio Unitario", fuente));
		...
		Font fuente2=FontFactory.getFont("Helvetica", 10, Color.BLACK);
		...
		for(Compras compra: compras) {
			...
			c6.setBackgroundColor(new Color(255,226,119));
			c6.setPadding(5);
			...
			celdaTotal.setBackgroundColor(new Color(255,200,1));
